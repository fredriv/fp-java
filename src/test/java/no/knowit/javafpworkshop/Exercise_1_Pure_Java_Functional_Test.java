...
public class Exercise_1_Pure_Java_Functional_Test {
	...
	public void numbers_below_100() {
		...
		final List<Integer> below_100 = numbers_below_100(numbers, emptyList);
	...
	private List<Integer> numbers_below_100(final List<Integer> numbers,
		...
		if (first < 100) {
			return numbers_below_100(rest, cons(first, resultSoFar));
		}
		return numbers_below_100(rest, resultSoFar);
	}
